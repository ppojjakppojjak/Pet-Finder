...
public class Allure_activity_cat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allure_activity_cat);
...
//        getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_chevron_left_white_24dp);
        ...
        TabPagerAdapter_cat pagerAdapter = new TabPagerAdapter_cat(getSupportFragmentManager(), tabLayout.getTabCount());
